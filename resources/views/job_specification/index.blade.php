                ...
                <div class="card-body">      
                  <div class="row justify-content-between">
                      <div class="col-md-4 col-xs-12">
                          <a href="/job_specification" class="btn btn-md btn-success">All Data</a> 
                          
                      </div>
                      <div class="col-md-4 col-xs-12">
                          <div class="form-group">
                              <form action="/job_specification" method="get" role="search" class="form-inline">
                  ...
                  <tr>
                    ...
                    <td>{{$value->link}}</td>
                    <td>
                    <a href="job_specification/{{$value->id}}" class="btn btn-xs btn-success"><i class="fa fa-eye p-1"></i></a>
                    <a href="job_specification/{{$value->id}}/edit" class="btn btn-xs btn-primary"><i class="fa fa-edit p-1"></i></a>
                    <form action="/job_specification/{{$value->id}}" method="post" style="display: inline-block;"  onsubmit="return confirm('Are you sure to delete?')">
                        {{ csrf_field() }}
                      {{ method_field('DELETE') }}
...
<div class="modal fade" id="exampleModalScrollable" tabindex="-1" role="dialog" aria-labelledby="exampleModalScrollableTitle" aria-hidden="true">
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      <form action="{{url('/job_specification')}}" method="post">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">Create Job Specification</h5>
      ...
      <div class="modal-body">
            ...
            @csrf
                ...
                <div class="form-group">
                    <label class="card-title float-left">JobSpecification Name *:</label>
