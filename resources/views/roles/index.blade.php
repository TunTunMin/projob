        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-header bg-info">
                    <h4 class="float-left my-1">Role</h4>
                    <div class="float-right">
                      <!-- Button trigger modal -->
                      <button type="button" class="btn btn-success" data-toggle="modal" data-target="#exampleModalScrollable">Add Role</button>
                    </div>
                </div>
                ...
                <div class="card-body">
                    <div class="row justify-content-between">
                        <div class="col-md-4 col-xs-12">
                            <a href="/roles" class="btn btn-md btn-success">All Data</a>

                        </div>
                        <div class="col-md-4 col-xs-12">
                            <div class="form-group">
                                <form action="/roles" method="get" role="search" class="form-inline">
                  ...
                  <table class="table table-stripped">
                    ...
                    <tbody>
                        @forelse ($data as $value)
                            <tr>
                                <td>{{$value->id}}</td>
                                <td>{{$value->specializations->name}}</td>
                                <td>{{$value->name}}</td>
                                <td>

                                <a href="/roles/{{$value->id}}/edit" class="btn btn-xs btn-primary"><i class="fa fa-edit p-1"></i></a>
                                <form action="/roles/{{$value->id}}" method="post" style="display: inline-block;"  onsubmit="return confirm('Are you sure to delete?')">
                                    {{ csrf_field() }}
                                    {{ method_field('DELETE') }}
  ...
  <div class="modal-dialog modal-dialog-scrollable" role="document">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalScrollableTitle">Create Role</h5>
