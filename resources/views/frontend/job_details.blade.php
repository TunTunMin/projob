...
<div class="container mt-4">
    ...
    <div class="row mt-2">
        ...
        <div class="col-md-6">
            ...
            <div class="card mt-2">
                <div class="card-body">
                        <h4><i class="fas fa-camera-retro"></i> Company Overview</h4>
                        ...
                        <div id="jssor_1" style="position:relative;margin:0 auto;top:0px;left:0px;width:980px;height:480px;overflow:hidden;visibility:hidden;">
                            ...
                            <div data-u="slides" style="cursor:default;position:relative;top:0px;left:0px;width:980px;height:380px;overflow:hidden;">
                                <div>
                                    <img data-u="image" src="{{asset('images/031.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/031-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/032.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/032-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/033.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/033-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/034.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/034-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/035.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/035-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/036.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/036-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/037.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/037-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/038.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/038-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/039.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/039-s190x90.jpg')}}" />
                                </div>
                                <div>
                                    <img data-u="image" src="{{asset('images/040.jpg')}}" />
                                    <img data-u="thumb" src="{{asset('images/040-s190x90.jpg')}}" />
