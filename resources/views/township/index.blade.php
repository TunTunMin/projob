...
<div class="container-fluid">
  ...
  <div class="card">
      <div class="card-header bg-info">
          ...
          <button class="btn btn-primary float-right" href="township/create" role="button" data-toggle="modal" data-target="#exampleModal">Add New Township</button>
        </div>
      <div class="card-body">
         <div class="row justify-content-between">
           <div class="col-md-4 col-xs-12">
              <a href="/township" class="btn btn-success btn-md">All Data</a>
           </div>
           <div class="col-md-4 col-xs-12">
              <div class="form-group">
                  <form class="form-inline" action="/township" method="GET">
        ...
        <table class="table table-striped">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>{{$item->name}}</td>
                <td>
                  <a href="/township/{{$item->id}}/edit" class="btn btn-xs btn-primary"><i class="far fa-edit p-1"></i></a>
                <form action="/township/{{$item->id}}" class="d-inline" method="post" onsubmit="return confirm('Are you sure to delete?')">
                    @csrf
                    @method('DELETE')
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Add Township</h5>
